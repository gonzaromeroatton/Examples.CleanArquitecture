...
public class GetPersonByDniQueryHandler : IRequestHandler<GetPersonByDniQuery, PersonDto>
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public GetPersonByDniQueryHandler(IPersonRepository leaveAllocationRepository,
        IMapper mapper)
    {
